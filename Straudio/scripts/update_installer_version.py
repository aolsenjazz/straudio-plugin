...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Straudio Demo Installer\n"
      else:
        line="OutputBaseFilename=Straudio Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Straudio Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Straudio installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Straudio Demo installer\n"
     else:
       line="SetupWindowTitle=Straudio installer\n"
