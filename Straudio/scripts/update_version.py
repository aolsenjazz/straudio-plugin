...
def main():
  ...
  plistpath = scriptpath + "/resources/Straudio-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Straudio-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Straudio-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Straudio-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Straudio-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Straudio.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Straudio.iss",inplace=1):
